...
//    n = new OsmNodeNamed();
//    n.name = "from";
//    n.longitude = 180000000 + (int) (flon * 1000000 + 0.5);
//    n.latitude = 90000000 + (int) (flat * 1000000 + 0.5);
//    wplist.add(n);
//
//    n = new OsmNodeNamed();
//    n.name = "to";
//    n.longitude = 180000000 + (int) (tlon * 1000000 + 0.5);
//    n.latitude = 90000000 + (int) (tlat * 1000000 + 0.5);
//    wplist.add(n);
//
