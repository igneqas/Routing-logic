...
import com.routerbackend.routinglogic.codec.TagValueValidator;
...
public final class BExpressionContextWay extends BExpressionContext implements TagValueValidator {
  ...
  private static String[] buildInVariables =
    {"costfactor", "turncost", "uphillcostfactor", "downhillcostfactor", "initialcost", "nodeaccessgranted", "initialclassifier", "priorityclassifier", "classifiermask", "maxspeed"};
